...
### ✨ 주요 기능
#### 1. 메인 페이지
* 리뷰 평점 추이, 분기별 리포트, 분기별 키워드를 한 눈에 확인할 수 있다.<br><br>
...
#### 2. 경쟁사 분석 (1) - 앱 순위
* 감정 분석을 통한 긍정/부정 리뷰 비율을 기반으로 소비자가 선호하는 기업의 순위를 알 수 있다.<br><br>
...
* AI가 제시한 부서별 문제 해결 방안도 확인할 수 있다.<br><br>
